...
public class CEProcessKafkaOut {
    ...
    public static void main(String[] args) throws Exception {
        ...
        producer_properties.setProperty("bootstrap.servers", "node01:9092,node02:9092,node03:9092");
        //所有follower都响应了才认为消息提交成功，即"committed"
        producer_properties.put("acks", "all");


        FlinkKafkaProducer<String> flinkKafkaProducer = new FlinkKafkaProducer<String>("longtermevent",new SimpleStringSchema(),producer_properties);
